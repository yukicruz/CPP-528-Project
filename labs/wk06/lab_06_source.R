...
reg.data$mhv.growth[ selected.vars$mhv.growth > 200 ] <- NA
reg.data$p.col <- log10( selected.vars$p.col + 1 )
reg.data$p.black <- log10( selected.vars$p.black+ 1 )
reg.data$p.unemp <- log10( selected.vars$p.unemp  + 1  )
